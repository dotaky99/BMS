...
class MyWidget(QWidget):
    ...
    def initUI(self):
        ...
        Tab2.set_tab2(self)
        Tab3.set_tab3(self)
        Tab3.set_timeline(self)
        Tab3.timeline_data1_2(self)
        Tab3.timeline_data1_3(self)
        Tab3.timeline_data1_4(self)
        Tab3.timeline_data1_5(self)
        Tab3.timeline_data2_2(self)
        Tab3.timeline_data2_3(self)
        Tab3.timeline_data2_4(self)
